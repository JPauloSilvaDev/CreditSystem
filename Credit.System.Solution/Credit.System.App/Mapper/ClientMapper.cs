...
namespace Credit.System.App.Mapper
{
    public static class ClientMapper
    {
        ...
        public static Client MapClientRegisterModelToClient(RegisterClientModel viewModel)
        {
            try
            {
                var client = new Client()
                {
                    ...
                    SecondaryName = string.IsNullOrWhiteSpace(viewModel.SecondaryName) ? null : viewModel.SecondaryName,
                    Email = viewModel.Email,
                    Document = viewModel.Document,
                    PrimaryPhone = viewModel.PrimaryPhone,
                    SecondaryPhone = string.IsNullOrWhiteSpace(viewModel.SecondaryPhone) ? null : viewModel.SecondaryPhone,
